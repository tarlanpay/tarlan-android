...
internal object Localization {
    ...
    val englishStrings = mapOf(
        ...
        KeyBillFailSubtitle to "For detailed information, contact technical support: support@tarlanpayments.kz",
        KeyBack to "Back",
        ...
        KeyCardNumberInvalidError to "Card number does not exist",
        KeyCardExpriredDateInvalidError to "Invalid card expiry date",
        ...
        KeyPhoneInvalidError to "Invalid phone number",
        KeyPhoneEmptyError to "Enter phone number",
    ...
    val russianStrings = mapOf(
        ...
        KeyPhoneInvalidError to "Неверный номер телефона",
        KeyPhoneEmptyError to "Введите номер телефона",
    ...
    val kazakhStrings = mapOf(
        ...
        KeyBillFail to "Бізде бір қате пайда болды!",
        KeyBillFailSubtitle to "Толығырақ ақпарат алу үшін техникалық қолдауға хабарласыңыз: support@tarlanpayments.kz",
        KeyBack to "Артқа",
        KeyAddCardHint to "Сақталған карталар",
        KeyRemovingCard to "Картаны жою",
        KeyBillCardLinkSuccessSubtitle to "Сіздің картаңыз сақталды және келесі төлем кезінде қолдануға қолжетімді болады.",
        KeyCommssion to "Комиссия",
        ...
        KeyCvvInvalidError to "Дұрыс емес CVV",
        KeyCvvEmptyError to "CVV енгізіңіз",
        KeyCardHolderInvalidError to "Картаның иесі дұрыс емес",
        KeyCardHolderEmptyError to "Картаның иесін енгізіңіз",
        KeyPhoneInvalidError to "Дұрыс емес телефон",
        KeyPhoneEmptyError to "Телефон нөмірін енгізіңіз",
        KeyEmailInvalidError to "Дұрыс емес email",
